...
public class ListCctvPolresta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_cctv_polresta);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("List Cctv Polresta");
        ...
        adapter = new AdapterCctv(ListCctvPolresta.this, newsList);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListCctvPolresta.this, PlayCctvPolresta.class);
    ...
    public void onBackPressed() {
        Intent a = new Intent(ListCctvPolresta.this, Apps.class);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(!error){
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(ListCctvPolresta.this);
